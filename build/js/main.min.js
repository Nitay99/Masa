...
var _headerSlider = require("./modules/sliders/header-slider");
var _programSlider = require("./modules/sliders/program-slider");
var _newsSlider = require("./modules/sliders/news-slider");
var _reviewSlider = require("./modules/sliders/review-slider");
var _initAccordion = require("./vendor/init-accordion");
var _filterTabs = require("./modules/filter-tabs");
var _contactsMap = require("./modules/contacts-map");
var _siteLinks = require("./modules/site-links");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _headerSlider.initHeaderSlider)();
  (0, _programSlider.initProgramSlider)();
  (0, _newsSlider.initSliderNews)();
  (0, _reviewSlider.initReviewSlider)();
  (0, _menu.setMenuClickHandler)();
  (0, _filterTabs.initTabs)();
  (0, _contactsMap.initContactsMap)();
  (0, _siteLinks.setNavLinksHandler)();
...
},{"./modules/contacts-map":2,"./modules/filter-tabs":3,"./modules/form-validate/form":5,"./modules/menu":11,"./modules/modals/init-modals":12,"./modules/select/custom-select":15,"./modules/site-links":17,"./modules/sliders/header-slider":18,"./modules/sliders/news-slider":19,"./modules/sliders/program-slider":20,"./modules/sliders/review-slider":21,"./utils/ios-vh-fix":24,"./vendor/init-accordion":27}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initContactsMap = void 0;
var initContactsMap = function initContactsMap() {
  if (document.getElementById('contacts-map')) {
    // eslint-disable-next-line
    var map = L.map('contacts-map').setView([55.02857452340479, 82.9281499970608], 16);
    // eslint-disable-next-line
    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
      attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
    }).addTo(map);
    // eslint-disable-next-line
    var marker = new L.Marker([55.02857452340479, 82.9281499970608]);
    marker.addTo(map);
  }
};
exports.initContactsMap = initContactsMap;
...
},{"../utils/scroll-lock":25}],4:[function(require,module,exports){
"use strict";
...
exports.setMenuClickHandler = void 0;
require("../utils/scroll-lock");
var menu = document.querySelector('.dropdown-menu');
var checkbox = menu ? menu.querySelector('input') : false;
var menuLinks = menu ? menu.querySelectorAll('.dropdown-menu__link') : false;
var submenuButtons = menu ? menu.querySelectorAll('.dropdown-menu__link-with-menu') : false;
var overlay = document.querySelector('.overlay');
var setMenuClickHandler = function setMenuClickHandler() {
  if (menu) {
...
exports.setMenuClickHandler = setMenuClickHandler;

},{"../utils/scroll-lock":25}],12:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":22,"../../utils/scroll-lock":25}],14:[function(require,module,exports){
"use strict";
...
},{"./create-select-markup":14,"./utils":16}],16:[function(require,module,exports){
"use strict";
...
exports.setNavLinksHandler = void 0;
var footer = document.querySelector('.main-footer');
var siteList = footer ? footer.querySelector('.site-list') : false;
var siteLinks = siteList ? siteList.querySelectorAll('a') : false;
var sections = ['about', 'programs', 'grant-details', 'reviews', 'news', 'contacts'];
var setNavLinksHandler = function setNavLinksHandler() {
  if (siteLinks.length >= 1) {
    siteLinks.forEach(function (siteLink) {
      siteLink.addEventListener('click', function (evt) {
        evt.preventDefault();
        sections.find(function (section) {
          if (siteLink.classList.contains("site-list__link--".concat(section))) {
            var sectionBlock = document.querySelector(".".concat(section));
            if (sectionBlock) {
...
exports.setNavLinksHandler = setNavLinksHandler;
...
exports.initHeaderSlider = void 0;
var _swiper = _interopRequireWildcard(require("../../vendor/swiper"));
...
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; } // eslint-disable-next-line
var headerSlider = document.querySelector('.hero__slider');
var initHeaderSlider = function initHeaderSlider() {
  _swiper.default.use([_swiper.Pagination]);
  // eslint-disable-next-line
  var swiper = new _swiper.default(headerSlider, {
    // Optional parameters
  ...
  var headerSlides = headerSlider ? headerSlider.querySelectorAll('.swiper-slide') : false;
  if (headerSlider && headerSlides) {
    headerSlides.forEach(function (item, index) {
      var buttons = item.querySelectorAll('a, span');
      if (index === activeIndex + 1) {
        ...
        if (index === activeIndex + 1) {
          ...
          try {
            for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
              ...
              _button2.setAttribute('tabindex', '-1');
            }
          } catch (err) {
            _iterator4.e(err);
          } finally {
...
exports.initHeaderSlider = initHeaderSlider;

},{"../../vendor/swiper":28}],19:[function(require,module,exports){
"use strict";
...
exports.initSliderNews = void 0;
var _swiper = _interopRequireWildcard(require("../../vendor/swiper"));
function _getRequireWildcardCache(nodeInterop) { if (typeof WeakMap !== "function") return null; var cacheBabelInterop = new WeakMap(); var cacheNodeInterop = new WeakMap(); return (_getRequireWildcardCache = function _getRequireWildcardCache(nodeInterop) { return nodeInterop ? cacheNodeInterop : cacheBabelInterop; })(nodeInterop); }
function _interopRequireWildcard(obj, nodeInterop) { if (!nodeInterop && obj && obj.__esModule) { return obj; } if (obj === null || _typeof(obj) !== "object" && typeof obj !== "function") { return { default: obj }; } var cache = _getRequireWildcardCache(nodeInterop); if (cache && cache.has(obj)) { return cache.get(obj); } var newObj = {}; var hasPropertyDescriptor = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var key in obj) { if (key !== "default" && Object.prototype.hasOwnProperty.call(obj, key)) { var desc = hasPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : null; if (desc && (desc.get || desc.set)) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } newObj.default = obj; if (cache) { cache.set(obj, newObj); } return newObj; }
// eslint-disable-next-line

var sliderNews = document.querySelector('.news__slider');
var newsCareerSlide = document.querySelector('.news__slide--career');
var newsTripSlide = document.querySelector('.news__slide--trip');
var newsVolunteerSlide = document.querySelector('.news__slide--volunteer');
var bigSlide = document.querySelector('.news__slide--big');
var initSliderNews = function initSliderNews() {
  _swiper.default.use([_swiper.Navigation, _swiper.Pagination, _swiper.Grid, _swiper.Manipulation]);
  // eslint-disable-next-line
  var swiper = new _swiper.default(sliderNews, {
    // Optional parameters
    direction: 'horizontal',
    loop: false,
    navigation: {
    ...
    pagination: {
      ...
      renderBullet: function renderBullet(index, className) {
        return '<span class="' + className + '">' + "".concat(index + 1) + '</span>';
      }
    },
    speed: 250,
    breakpoints: {
  ...
  var swiperWrap = sliderNews ? sliderNews.querySelector('.swiper-wrapper') : null;
  var slides = swiperWrap ? swiperWrap.querySelectorAll('.swiper-slide') : null;
  if (slides) {
    slides.forEach(function (child, i, children) {
...
},{"../../vendor/swiper":28}],20:[function(require,module,exports){
"use strict";
...
exports.initProgramSlider = void 0;
var _swiper = _interopRequireWildcard(require("../../vendor/swiper"));
function _getRequireWildcardCache(nodeInterop) { if (typeof WeakMap !== "function") return null; var cacheBabelInterop = new WeakMap(); var cacheNodeInterop = new WeakMap(); return (_getRequireWildcardCache = function _getRequireWildcardCache(nodeInterop) { return nodeInterop ? cacheNodeInterop : cacheBabelInterop; })(nodeInterop); }
function _interopRequireWildcard(obj, nodeInterop) { if (!nodeInterop && obj && obj.__esModule) { return obj; } if (obj === null || _typeof(obj) !== "object" && typeof obj !== "function") { return { default: obj }; } var cache = _getRequireWildcardCache(nodeInterop); if (cache && cache.has(obj)) { return cache.get(obj); } var newObj = {}; var hasPropertyDescriptor = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var key in obj) { if (key !== "default" && Object.prototype.hasOwnProperty.call(obj, key)) { var desc = hasPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : null; if (desc && (desc.get || desc.set)) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } newObj.default = obj; if (cache) { cache.set(obj, newObj); } return newObj; }
// eslint-disable-next-line
...
var initProgramSlider = function initProgramSlider() {
  _swiper.default.use([_swiper.Navigation]);
  // eslint-disable-next-line
  var swiper = new _swiper.default(programSlider, {
    // Optional parameters
    direction: 'horizontal',
    loop: false,
    navigation: {
...
exports.initProgramSlider = initProgramSlider;

},{"../../vendor/swiper":28}],21:[function(require,module,exports){
"use strict";
...
exports.initReviewSlider = void 0;
var _swiper = _interopRequireWildcard(require("../../vendor/swiper"));
function _getRequireWildcardCache(nodeInterop) { if (typeof WeakMap !== "function") return null; var cacheBabelInterop = new WeakMap(); var cacheNodeInterop = new WeakMap(); return (_getRequireWildcardCache = function _getRequireWildcardCache(nodeInterop) { return nodeInterop ? cacheNodeInterop : cacheBabelInterop; })(nodeInterop); }
function _interopRequireWildcard(obj, nodeInterop) { if (!nodeInterop && obj && obj.__esModule) { return obj; } if (obj === null || _typeof(obj) !== "object" && typeof obj !== "function") { return { default: obj }; } var cache = _getRequireWildcardCache(nodeInterop); if (cache && cache.has(obj)) { return cache.get(obj); } var newObj = {}; var hasPropertyDescriptor = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var key in obj) { if (key !== "default" && Object.prototype.hasOwnProperty.call(obj, key)) { var desc = hasPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : null; if (desc && (desc.get || desc.set)) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } newObj.default = obj; if (cache) { cache.set(obj, newObj); } return newObj; }
// eslint-disable-next-line
...
var initReviewSlider = function initReviewSlider() {
  _swiper.default.use([_swiper.Navigation]);
  // eslint-disable-next-line
  var swiper = new _swiper.default(reviewSlider, {
    // Optional parameters
    direction: 'horizontal',
    loop: false,
    navigation: {
...
exports.initReviewSlider = initReviewSlider;

},{"../../vendor/swiper":28}],22:[function(require,module,exports){
"use strict";
...
},{"./ios-checker":23}],25:[function(require,module,exports){
"use strict";
...
},{"./ios-checker":23}],26:[function(require,module,exports){
"use strict";
...
},{"./accordions":26}],28:[function(require,module,exports){
